...
<html>
	<head>
		<meta charset="utf-8" />
		<?php $id=$_GET['id'];?>
		<title>Admin Page-Update Subject</title>
				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							...
							<li class="active"><a href="page-admin-teacher.php?id=<?php echo $id;?>">Teacher</a></li>
							<li class="dropdown">
					...
					<div class="row">
		                ...
		                while($row = oci_fetch_array($result)){
                       	?>
							...
							<h2 align="center"><b>Update Subject</b></h2>

							<form class="white-row" method="post" action="sql-updateSubject.php?id=<?php echo $id;?>">
								
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Subject Code</label>
											<input type="text" readonly="readonly" name="subcode" class="form-control" value="<?php echo $row['SUB_CODE'];?>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text"name="submodule" class="form-control" value="<?php echo $row['SUB_MODULE'];?>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div align="center">
										...
										<a href="page-admin-viewsubject.php?id=<?php  echo $id; ?>" class="btn btn-primary">Back</a>
									</div>
								</div>
								<div class="col-md-4"></div>
							</form>
