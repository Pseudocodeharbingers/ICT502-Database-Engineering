				...
				<div align="center">
					...
					<table border="2" id="tablestyle">
                     ...
                     Print '<tr>
                        ...
                        <td>'.$row['SUB_PRICE'].'</td>
                        <td><a href="page-admin-updatesubject.php?id='.$id.'&code='.$row['SUB_CODE'].'">Update</a></td>
                        <td><a onclick="javascript:confirmationDelete($(this));return false;" href="sql-deleteSubject.php?id='.$id.'&code='.$row['SUB_CODE'].'">Delete</a></td>
                     </tr>';
                   }
                ?>
					</table>
