...
<html>
	<head>
		...
		<?php $id=$_GET['id'];?>
		<?php $idd=$_GET['idd'];?>
		<title>Admin Page-Update-Teacher-details</title>
				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							<li ><a href="page-admin-admin-approvement-form.php?id=<?php echo $id;?>">Admin Approvement</a></li>
							<li class="active"><a href="page-admin-teacher-approvement-form.php?id=<?php echo $id;?>">Teacher Approvement</a></li>
				...
				<section class="container">
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<h2 align="center"><b>Update Teacher's Detail</b></h2>

							<form class="white-row" method="post" action="sql-update-teacher-detail.php?id=<?php echo $id; ?>&idd=<?php echo $idd;?>">
								
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label>Teacher Salary (RM)</label>
											<input type="text" name="tcrsalary" class="form-control" required="required">
										</div>
									</div>
								</div>
								<div class="row">
