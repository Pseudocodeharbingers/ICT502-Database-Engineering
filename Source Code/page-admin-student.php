				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							...
							<li class="active"><a href="page-admin-student.php?id=<?php echo $id;?>">Student</a></li>
				...
				<div align="center" class="container">
					<table border="2" id="tablestyle">
                     ...
                     Print '<tr>
                        ...
                        <td><a href="page-admin-student-details.php?id='.$id.'&idd='.$row['STU_ID'].'">Details</a></td>
                        <td><a onclick="javascript:confirmationDelete($(this));return false;" href="page-admin-student-delete.php?id='.$id.'&idd='.$row['STU_ID'].'">Delete</a></td>
                     </tr>';
                   }
                ?>
					</table>
