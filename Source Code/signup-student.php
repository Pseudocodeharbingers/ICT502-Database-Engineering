	...
	<body>
		<header id="topNav">
					<div class="container">
						...
						<!-- Logo text or image -->
						<a class="logo scrollTo" href="index.php">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="center-box">
						...
						<div class="row text-left">
							<div class="col-md-12">
								<form name="studentsignupform" action="sql-signup-student.php" method="post">
									<div class="col-md-6">
										Full Name<input type="text" name="stdname" class="form-control" required="required"><br>

										IC Number<input type="text" name="stdic" class="form-control" placeholder="e.g: 123456789012" required="required"><br>
										...
										Email<input type="text" name="stdemail" class="form-control" required="required"><br>

										Address<textarea name="stdaddress" class="form-control" required="required"></textarea>


									</div>
									<div class="col-md-6">

										Phone Number<input type="text" name="stdphone" class="form-control" required="required"><br>

										Parent Phone Number<input type="text" name="stdtel" class="form-control" required="required"><br>

										School Name<input type="text" name="stdschoolname" class="form-control" required="required"><br>

										Password<input type="Password" name="stdpass" class="form-control" required="required"><br>

										Confirmation Password<input type="Password" name="stdconfirmpass" class="form-control" required="required"><br>
