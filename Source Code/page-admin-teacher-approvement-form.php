			...
			<section id="" class="padding60">
				...
				<div class="container">
					<div align="center" class="container">
                       ...
                       $sql = "SELECT * FROM staff s JOIN teacher t ON (t.sta_id = s.sta_id) WHERE sta_approvement = '0' ORDER BY sta_hiredate ASC";
                     ...
                     Print '<tr>
                        <td>'.$row['STA_ID'].'</td>
                        <td>'.$row['STA_NAME'].'</td>
                        <td><a href="page-admin-teacher-approvement-form2.php?id='.$id.'&idd='.$row['STA_ID'].'">Details</a></td>
                     </tr>';
                   }
                ?>
					</table>
