				...
				<div class="col-md-8 col-md-offset-2">
					<div class="center-box">
						...
						<div class="row text-left">
							<div class="col-md-12">
								<form name="teachersignupform2" action="sql-signup-teacher.php" method="post">
									<div>
										<input type="HIDDEN" name="id" value="<?php echo $row["STA_ID"];?>">
										<div class="col-md-4"><h4>School Name</h4></div>
										<input type="text" name="tcrschoolname" class="form-control"><br>
										<div class="col-md-4"><h4>Teacher Highest Certificate</h4></div>
										<input type="text" name="tcrcertid" class="form-control" required="required"><br>
										...
										<div class="toogle">
												...
												<div class="toggle">
													...
													<div class="toggle-content">
														<input type="checkbox" name="bm" > Bahasa Melayu<br>
														<input type="checkbox" name="bi" > English<br>
														<input type="checkbox" name="mt" > Mathematics<br>
														<input type="checkbox" name="sc" > Science<br>	
													</div>
												</div>
										</div>
									</div>
									<div align="center"><br>
										...
										<a href="login-teacher.php" class="btn btn-primary" onclick="go()">Exit</a>
									</div>	
