			...
			<section id="" class="padding60">
				...
				<div align="center" class="container">
					<table border="2" id="tablestyle">
                       ...
                       $sql = "SELECT * FROM staff s JOIN teacher t ON (t.sta_id = s.sta_id) WHERE sta_approvement = '1'";
                     ...
                     Print '<tr>
                        <td>'.$row['STA_ID'].'</td>
                        <td>'.$row['STA_NAME'].'</td>
                        <td><a href="page-admin-teacher-details.php?id='.$id.'&idd='.$row['STA_ID'].'">Details</a></td>
                        <td><a onclick="javascript:confirmationDelete($(this));return false;" href="sql-page-admin-teacher-delete.php?id='.$row['STA_ID'].'&idd='.$row['STA_ID'].'">Delete</a></td>
                     </tr>';
                   }
                ?>
					</table>
