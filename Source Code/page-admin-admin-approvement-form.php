...
<html>
	<head>
		<?php $id=$_GET['id'];?>
		<meta charset="utf-8" />
		<title>Admin Page-Admin-Approvement</title>
		<script>
	...
	<body background="assets/images/coverpage4.jpg">
				...
				<div class="navbar-collapse nav-main-collapse collapse pull-right">
					<nav class="nav-main mega-menu">
						<ul class="nav nav-pills nav-main scroll-menu" id="topMain">
							<li class="active"><a href="page-admin-admin-approvement-form.php?id=<?php echo $id;?>">Admin Approvement</a></li>
							<li ><a href="page-admin-teacher-approvement-form.php?id=<?php echo $id;?>">Teacher Approvement</a></li>
							<li><a href="page-admin-student.php?id=<?php echo $id;?>">Student</a></li>
							<li ><a href="page-admin-teacher.php?id=<?php echo $id;?>">Teacher</a></li>
							<li class="dropdown">
								<a class="dropdown-toggle" href="#">
									Subject <i class="fa fa-angle-down"></i>
								</a>
								<ul class="dropdown-menu">
									<li><a href="page-admin-viewsubject.php?id=<?php echo $id;?>">View Subject</a></li>
									<li><a href="page-admin-addsubject.php?id=<?php echo $id;?>">Add Subject</a></li>
								</ul>
							</li>
		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				<h2 align="center"><b>Admin's Approvement List</b></h2>
				<div class="container">
					<div align="center" class="container">
						<table border="2" id="tablestyle">
						<tr >
							<td width="20%">Admin ID</td>
							<td >Admin Name</td>
							<td >Admin IC</td>
							<td >Admin Email</td>
							<td >Admin Address</td>
                      ...
                      include "dbconnect.php";
						...
						$sql = "SELECT * FROM staff s JOIN admin t ON (t.sta_id = s.sta_id) WHERE sta_approvement = '0' ORDER BY sta_hiredate ASC";
                     ...
                     Print '<tr>
                        ...
                        <td><a onclick="javascript:confirmationApprove($(this));return false;" href="approvement.php?id='.$id.'&idd='.$row['STA_ID'].'"><input type="button" name="btnapprove" value="Approve" class="btn btn-primary" ></a></td>
                        <td><a onclick="javascript:confirmationDisapprove($(this));return false;" href="disapprovement.php?id='.$id.'&idd='.$row['STA_ID'].'"><input type="button" name="btndisapprove" value="Disapprove" class="btn btn-primary" ></a></td>
                     </tr>';
                   }
                ?>
					</table>
