				...
				<section class="container">
					...
					<div class="row">
						...
						<!-- LOGIN -->
							...
							<form name="studentsignupform" action="sql-page-student-update.php?id=<?php echo $id;?>" method="post">
									<div class="col-md-6">
										Full Name<input type="text" name="stdname" class="form-control" required="required" value="<?php echo $row['STU_NAME']?>"><br>

										IC Number<input type="text" name="stdic" class="form-control" placeholder="e.g: 123456789012" required="required" value="<?php echo $row['STU_IC']?>"><br>
										
										<div class="col-md-6">
											Gender<br>
											<select name="stdgender">
											<option value="<?php echo $row['STU_GENDER']?>"><?php echo $row['STU_GENDER']?></option>
										...
										<div class="col-md-6">
											...
											<option value="ps1">Primary 1</option>
											<option value="ps2">Primary 2</option>
											<option value="ps3">Primary 3</option>
											<option value="ps4">Primary 4</option>
											<option value="ps5">Primary 5</option>
											<option value="ps6">Primary 6</option>
											</select>
										</div>

										Email<input type="text" name="stdemail" class="form-control" required="required" value="<?php echo $row['STU_EMAIL']?>"><br>

										Address<textarea name="stdaddress" class="form-control" required="required" ><?php echo $row['STU_ADDRESS']?></textarea>


									</div>
									<div class="col-md-6">

										Phone Number<input type="text" name="stdphone" class="form-control" required="required" value="<?php echo $row['STU_TELNUM']?>"><br>

										Parent Phone Number<input type="text" name="stdtel" class="form-control" required="required" value="<?php echo $row['STU_PARENTNUM']?>"><br>

										School Name<input type="text" name="stdschoolname" class="form-control" required="required" value="<?php echo $row['STU_SCHOOLNAME']?>"><br>
