		...
		<div id="wrapper">
			...
			<section id="" class="padding60">
				...
				?>
					...
					<div align="right"><br>
						<a onclick="javascript:confirmationApprove($(this));return false;" href="approvement1.php?id=<?php echo $id; ?>&idd=<?php echo $idd; ?>"><input type="button" name="btnapprove" value="Approve" class="btn btn-primary" ></a>
                        <a onclick="javascript:confirmationDisapprove($(this));return false;" href="disapprovement1.php?id=<?php echo $id; ?>&idd=<?php echo $idd; ?>"><input type="button" name="btndisapprove" value="Disapprove" class="btn btn-primary" ></a>
					</div>
				</div>
			</section>
			<!-- /ABOUT US -->
